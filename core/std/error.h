 ...
 * environments (when [NDEBUG] is defined), and should not be used to handle
...
/**
 * Forcefully crashes the program and generates a crash report with semantics
 * equivalent to the standard [abort] function.
 */
