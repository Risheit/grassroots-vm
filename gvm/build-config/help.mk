...
help:
	...
	@echo "run: Runs the built executable. Use the ARGS variable to pass command line arguments to the program. If any changes have been made to the source code, this will rebuild the executable as well."
